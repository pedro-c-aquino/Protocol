...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let pessoa1 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image1", customID: 1)
        let pessoa2 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image2", customID: 2)
        let pessoa3 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image3", customID: 3)
        let pessoa4 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image4", customID: 4)
        let pessoa5 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image5", customID: 5)
        let pessoa6 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image1", customID: 6)
        let pessoa7 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image2", customID: 7)
        let pessoa8 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image3", customID: 8)
        let pessoa9 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image4", customID: 9)
        let pessoa10 = Pessoa(nome: "Pedro", sobrenome: "Aquino", idade: 35, genero: .masculino, avatar: "image5", customID: 10)
